...
两个包的主要绘图函数，并充分考虑了空间可视化的特点，添加了诸如指北针、比例尺等专业地图要素的绘制，\emphText{使得空间数据可视化在方法尽量与普通数据绘图一致的基础上又体现出专业性}，这样用户可以把更多的精力放在处理和分析空间数据上，而不需要再专门花时间学习一套新的绘图系统b\end{itemize}
\end{frame}
