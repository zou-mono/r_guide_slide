...
\subsubsection{几何对象(geometric object)}
\begin{frame}[t,fragile]{\subsecname}{\subsubsecname}
\begin{itemize}
...
\subsubsection{统计变换(statistical transformations)}
\begin{frame}[t,fragile]{\subsecname}{\subsubsecname}
\begin{itemize}
...
\subsubsection{位置调整(position adjustments)}
\begin{frame}[t]{\subsecname}{\subsubsecname}
\begin{itemize}
...
\subsubsection{坐标系(coordinate system)}
\begin{frame}[t,fragile]{\subsecname}{\subsubsecname}
\begin{itemize}
