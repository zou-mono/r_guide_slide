...
\begin{minipage}{\textwidth}
\centering
\includegraphics[width=0.8\columnwidth]{ggplot_mapping1.png}
\end{minipage}
\end{onlyenv}
...
\begin{minipage}{\textwidth}
\centering
\includegraphics[width=0.8\columnwidth]{ggplot_mapping2.png}
\end{minipage}
\end{onlyenv}
\end{frame}
...
\begin{minipage}{\textwidth}
\centering
\includegraphics[width=0.9\columnwidth]{ggplot_scales.png}
\end{minipage}
\end{onlyenv}
\end{overlayarea}
\end{frame}
...
\begin{minipage}{\textwidth}
\centering
\includegraphics[width=0.9\columnwidth]{ggplot_facet2.png}
\end{minipage}
\end{onlyenv}
...
\begin{minipage}{\textwidth}
\centering
\includegraphics[width=0.9\columnwidth]{ggplot_facet3.png}
\end{minipage}
\end{onlyenv}
...
\only<6>{\vspace{-20pt}
    \begin{figure}
      ...
      {\includegraphics[width=0.45\columnwidth]{ggplot_facet4_1.png}} \hspace{1pt}
      \subfloat[scales=``free'']
      {\includegraphics[width=0.45\columnwidth]{ggplot_facet4_2.png}}
      \caption{控制标度属性的示例}
...
\only<2>{
    ...
    \begin{figure} \centering
      ...
      {\includegraphics[width=0.3\columnwidth]{ggplot_position1_1.png}} \hspace{1pt}
      \subfloat[position=``fill'']
      {\includegraphics[width=0.3\columnwidth]{ggplot_position1_2.png}} \hspace{1pt}
      \subfloat[position=``dodge'']
      {\includegraphics[width=0.3\columnwidth]{ggplot_position1_3.png}} 
...
\only<2>{
    \begin{figure} \centering
      ...
      \subfloat[cartesian()]
      {\includegraphics[width=0.2\columnwidth]{ggplot_coord1_1.png}} \hspace{20pt}
      \subfloat[polar(``x'')]
      {\includegraphics[width=0.2\columnwidth]{ggplot_coord1_2.png}} \hspace{20pt}
      \subfloat[polar(``y'')]
      {\includegraphics[width=0.2\columnwidth]{ggplot_coord1_3.png}} \hspace{20pt}
      \subfloat[flip()]
      {\includegraphics[width=0.2\columnwidth]{ggplot_coord1_4.png}} \hspace{20pt}
      \subfloat[trans(y=``log10'')]
      {\includegraphics[width=0.2\columnwidth]{ggplot_coord1_5.png}} \hspace{20pt}
      \subfloat[equal()]
      {\includegraphics[width=0.2\columnwidth]{ggplot_coord1_6.png}} 
      \caption{直线与矩形在不同坐标系的变换}
    \end{figure}}
\end{overlayarea}
\end{frame}
...
\begin{minipage}{\textwidth}
\centering
\includegraphics[width=0.8\columnwidth]{ggplot_first_example.png}
\end{minipage}
\end{onlyenv}
\end{overlayarea}
\end{frame}
